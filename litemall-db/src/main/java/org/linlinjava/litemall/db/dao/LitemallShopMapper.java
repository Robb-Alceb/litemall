...
public interface LitemallShopMapper {
     ...
     * @mbg.generated
     */
    LitemallShop selectOneByExampleWithBLOBs(LitemallShopExample example);
     ...
     * @mbg.generated
     */
    List<LitemallShop> selectByExampleWithBLOBs(LitemallShopExample example);
     ...
     * @mbg.generated
     */
    int updateByExampleWithBLOBs(@Param("record") LitemallShop record, @Param("example") LitemallShopExample example);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKeyWithBLOBs(LitemallShop record);
