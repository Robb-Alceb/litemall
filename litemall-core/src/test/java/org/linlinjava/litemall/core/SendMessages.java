...
public class SendMessages {
    ...
    public static String senderAddress = "alceb.liu@gmail.com";

    // The address on the "To" line. If your Amazon Pinpoint account is in
    // the sandbox, this address also has to be verified. 
    public static String toAddress = "alceb.liu@gmail.com";

    // The Amazon Pinpoint project/application ID to use when you send this message.
    // Make sure that the SMS channel is enabled for the project or application
    // that you choose.
    public static String appId = "188c7f6b950a4ab49c8760cdb7e5a781";
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            BasicAWSCredentials awsCredentials = new BasicAWSCredentials("AKIAW2VXHSVCJYXUONED", "9T4cl6oXDiv9yfkgPyw5HzkKUUD58mRZkZtvs20n");
