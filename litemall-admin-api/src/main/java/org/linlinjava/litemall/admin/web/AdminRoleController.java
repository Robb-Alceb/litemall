...
public class AdminRoleController {
    ...
    public Object list(String name,
                       @RequestParam(value = "shopId", required = false) @LoginAdminShopId Integer shopId,
    ...
    @GetMapping("/options")
    @LogAnno
    public Object options(@RequestParam(value = "shopId", required = false) @LoginAdminShopId Integer shopId) {
